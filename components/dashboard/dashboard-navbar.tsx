...
export function DashboardNavbar() {
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-3rem)] max-w-7xl flex items-center justify-between pointer-events-none">
        ...
        <AnimatePresence>
          {isPopoverOpen && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-3 w-48 p-2 rounded-2xl border border-white/10 bg-neutral-900/90 backdrop-blur-2xl shadow-2xl"
            >
